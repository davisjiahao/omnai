...
Turn the reported symptom into a deterministic reproduction or a concrete instrumentation plan. Record exact conditions, inputs, expected behavior, actual behavior, and evidence. Do not propose fixes yet.
