...
export const projectConfigSchema = z.object({
  ...
  activeChange: z.string().nullable().default(null),
  defaultScenario: z.string().default('small-feature'),
  installedHosts: z.array(z.enum(['claude', 'codex', 'opencode'])).default([]),
