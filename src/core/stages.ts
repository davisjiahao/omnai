...
const STAGES: Record<Capability, StageDefinition> = {
  ...
  map: { outputs: ['map.yaml'], context: ['intent.md', 'research.md', 'map.yaml'], outputContract: 'Write map.yaml with destination, decisions.resolved, decisions.frontier, decisions.blocked, fog, and outOfScope.' },
